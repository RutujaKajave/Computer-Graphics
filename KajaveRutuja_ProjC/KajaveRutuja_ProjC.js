...
function drawMyScene_1(gl, currentAngle, canvas) {
    ...
    modelMatrix.translate(1.0, 3.0, 1.0);
    ...
    modelMatrix.setTranslate(5.3, 2.0, 5.5);
    modelMatrix.scale(1.4, 0.4, 0.4);
    modelMatrix.rotate(currentAngle * 4, 1, 1, 1);
    mvpMatrix.set(projMatrix).multiply(viewMatrix).multiply(modelMatrix);
    gl.uniformMatrix4fv(u_MvpMatrix, false, mvpMatrix.elements);
    gl.uniformMatrix4fv(u_ModelMatrix, false, modelMatrix.elements);
    normalMatrix.setInverseOf(modelMatrix);
    ...
    gl.drawArrays(gl.LINE_LOOP, DBStart / floatsPerVertex, DBVerts.length / floatsPerVertex);
    ...
    modelMatrix.setTranslate(3.3, 1.5, -5.5);
    modelMatrix.scale(1.4, 0.6, 0.7);
    ...
    modelMatrix.setTranslate(5.0, 0, 0);
    modelMatrix.rotate(180.0, 1, 0, 1);
    // modelMatrix.rotate(90.0, 1, 0, 0);
    modelMatrix.scale(1.0, 1.0, 1.0);
    modelMatrix.rotate(5 * currentAngle, 0, 0, 1);
    mvpMatrix.set(projMatrix).multiply(viewMatrix).multiply(modelMatrix);
    gl.uniformMatrix4fv(u_MvpMatrix, false, mvpMatrix.elements);
    gl.uniformMatrix4fv(u_ModelMatrix, false, modelMatrix.elements);
    normalMatrix.setInverseOf(modelMatrix);
 ...
 modelMatrix.setTranslate(5.0, 5.0, 5.0);
    mvpMatrix.set(projMatrix).multiply(viewMatrix).multiply(modelMatrix);
    // modelMatrix = modelMatrix.multiply(viewMatrix);
    // mvpMatrix = projMatrix.multiply(modelMatrix);
    gl.uniformMatrix4fv(u_MvpMatrix, false, mvpMatrix.elements);
    ...
    var matl_1 = new Material(mSphere);
    drawMySceneRepeat(gl, g_ShaderID1, lamp_1, matl_1);
    viewMatrix.rotate(360.0, 0, 1, 0);
    // modelMatrix.setTranslate(0.0, 1.0, 0.0);
    // modelMatrix.scale(0.3, 0.3, 0.3);
    modelMatrix.translate(-10.0, 0.0, 0.0);
    modelMatrix.scale(1.0, 1.0, 1.0);
    modelMatrix.rotate(currentAngle * 2 , 1, 0, 1)
    mvpMatrix.set(projMatrix).multiply(viewMatrix).multiply(modelMatrix);
    // modelMatrix = modelMatrix.multiply(viewMatrix);
...
function makeTetrahedron() {
    ttrVerts = new Float32Array([
        ...
        // Face 0
        1.00, 1.00, 1.00, 1.00, 3.00, -0.87, 1.74, // Node 0
        1.00, 2.00, 2.00, 1.00, 3.00, -0.87, 1.74, // Node 1
        0.87, 2.00, 0.50, 1.00, 3.00, -0.87, 1.74, // Node 2
        // Face 1(front)
        1.00, 1.00, 1.00, 1.00, 1.00, -0.87, -3.48, // Node 0
        0.87, 2.00, 0.50, 1.00, 1.00, -0.87, -3.48, // Node 2
        -0.87, 2.00, 0.50, 1.00, 1.00, -0.87, -3.48, // Node 3
        // Face 2
